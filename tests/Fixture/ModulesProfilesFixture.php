...
class ModulesProfilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_modules_profiles_modules1' => ['type' => 'foreign', 'columns' => ['module_id'], 'references' => ['modules', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_modules_profiles_profiles1' => ['type' => 'foreign', 'columns' => ['profile_id'], 'references' => ['profiles', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'edit' => 1,
                'delete' => 1,
                'created' => '2019-02-16 00:29:20',
                'modified' => '2019-02-16 00:29:20'
            ],
        ];
        parent::init();
    }
