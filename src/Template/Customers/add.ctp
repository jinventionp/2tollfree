        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-group mb-3">
                            <?=$this->Form->hidden('opening_days', ["id" => "opening_days", "value" => ''])?>
                            <?=$this->Form->hidden('opening_days_action', ["id" => "opening_days_action", "value" => 'add'])?>
                            <label class="mb-2">Días de Apertura</label>
                            <br>

                            <div class="checkbox checkbox-primary form-check-inline">
                                <input id="days-1" type="checkbox" checked="" value="lu" >
                                <label for="days-1">Lu</label>
                            </div>
                            <div class="checkbox checkbox-primary form-check-inline">
                                <input id="days-2" type="checkbox" checked="" value="ma" >
                                <label for="days-2">Ma</label>
                            </div>
                            <div class="checkbox checkbox-primary form-check-inline">
                                <input id="days-3" type="checkbox" checked="" value="mi" >
                                <label for="days-3">Mi</label>
                            </div>
                            <div class="checkbox checkbox-primary form-check-inline">
                                <input id="days-4" type="checkbox" checked="" value="ju" >
                                <label for="days-4">Ju</label>
                            </div>
                            <div class="checkbox checkbox-primary form-check-inline">
                                <input id="days-5" type="checkbox" checked="" value="vi" >
                    ...
                    <div class="col-lg-4">
                        <div class="form-group mb-3 switchery-demo">
                        	<input id="sponsor" name="sponsor" type="checkbox" data-plugin="switchery" data-color="#9261c6" data-size="small"/>
