                    ...
                    <table class="table table-centered table-sm">
                        ...
                        <tbody>
                            ...
                            foreach ($modules as $module): 
                                ...
                                //pr($itemModule);
                                $seeCheck = ($itemModule->_joinData->see)? 'checked="checked"' : '';
                                $newCheck = ($itemModule->_joinData->new)? 'checked="checked"' : '';
                                $editCheck = ($itemModule->_joinData->edit)? 'checked="checked"' : '';
                                $eraseCheck = ($itemModule->_joinData->erase)? 'checked="checked"' : '';
                                //echo $seeCheck;
                                ?>
                            <tr>
